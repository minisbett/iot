...
namespace Iot.Device.Si5351.Internal.Infrastructure
{
    /// <summary>
        ...
        : IDisposable
    {
        ...
        /// </summary>
        /// <param name="registerAddress">Register address</param>
        public byte Read(Address registerAddress)
        {
        ...
        /// <param name="registerAddress">Register address</param>
        /// <param name="data">Byte to be written to the register</param>
        public void Write(Address registerAddress, byte data)
        {
            Span<byte> output = stackalloc byte[2];
            output[0] = (byte)registerAddress;
            output[1] = data;
            _i2cDevice.Write(output);
        }
    }
